...
`docs/macro_language.md` updated. His own direct instruction as
authority (`0065` §2, quoted in the report); the report lands on `main`,
not here. His check: record a dormer in the recorder, replay the text on
