...
coincides with a roof face). NOTHING IS OWED. Next, per
[`0186`](handoff/0186-ruling.md) §5: the R5b dormer read-back (a report,
no code — RED until he rules on it).** `viewer/fp3d.py`: the roof clips are computed
