...
| | |
|---|---|
| **`main`** | **`4d6550a`** at this file's cut. PR #39/#37/#38/#40/#41/#42/#43 all merged. **`0108`-`0110`'s three snap-to-grid features COMPLETE.** **Still open, Patrick's alone, no code blocks it: the `L2.dxf` Chief recount** (`0066` §6's closing receipt for item C). **D81/D82 CLOSED** — full trail: [`handoff/0121-report.md`](handoff/0121-report.md), [`0122-report.md`](handoff/0122-report.md). **TRANCHE 2 (aligned dimensions for angled walls) IS AUTHORISED AND BUILDING — [`0123-ruling.md`](handoff/0123-ruling.md).** Split into two branches per its own tier table (`0124-report.md`'s routing note): **1. `dim_row_along` refactor** ([`0119`](handoff/0119-ruling.md) §3) — GREEN, BUILT on branch `dim-row-along-refactor`, gate GREEN, PR pending, merges autonomously once CI is green. **2. The room-`show_dimensions`-driven angled lane** ([`0120`](handoff/0120-ruling.md) §2) — AMBER, own branch, built ON TOP of the merged refactor, stops for Patrick's check. Full trail: `handoff/README.md`'s pair table. **Numbering collisions, on the record:** `0036`, `0043`, `0050`, `0101`; neither renamed, numbering continues forward each time. |
