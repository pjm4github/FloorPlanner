...
walls stick up through the roof"*) — BUILT, AMBER, STOPPED FOR HIS 3D
LOOK: [PR #62](https://github.com/pjm4github/FloorPlanner/pull/62) on
`roofs-3d-wall-clip`, report [`0188-report.md`](handoff/0188-report.md)
(this commit lands it).** `viewer/fp3d.py`: the roof clips are computed
