    ...
    return {
        ...
        "furnishings": [
            ...
            {"kind": "stairs", "pos": [80.0, 10.0], "rotation": 90.0,
             "flight": "half", "turn": "left", "direction": "up"},
        ],
    }
...
def test_floors_and_active_floor_not_yet_serialized():
    """Phase A keeps the v3 shape exactly: the floor scaffolding is in-memory
    only (the Floors feature owns the v4 emission)."""
    ...
    assert all("floor" not in w for w in out["walls"])
