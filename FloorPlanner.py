...
# App-wide constants, plan settings, and path/font/icon helpers.
from floorplanner.config import *  # noqa: E402,F403  (shared constants/SETTINGS)
# Pure geometry / formatting / item-stacking helpers.
from floorplanner.geometry import *  # noqa: E402,F403
# Furnishing symbol library + AI pricing.
from floorplanner.catalog import *  # noqa: E402,F403
# Scene graphics items + their geometry algorithms.
from floorplanner.walls import *  # noqa: E402,F403
from floorplanner.rooms import *  # noqa: E402,F403
from floorplanner.items import *  # noqa: E402,F403
# underscore internals that star-import skips, but app code + tests reference.
from floorplanner.rooms import _wall_endpoints_match  # noqa: E402,F401
from floorplanner.walls import (  # noqa: E402,F401
    _WallBBoxIndex,
    _coalesce_all_impl,
    _coalesce_wall_impl,
)
# Qt-free domain model: the single definition of the JSON schema.
# serialize()/load_data() bridge the scene to/from these dataclasses.
from floorplanner.model import (  # noqa: E402,F401  (tests use fp.FILE_FORMAT)
    FILE_FORMAT,
    FILE_VERSION,
    Furnishing,
...
# Constants, plan SETTINGS, path/font/icon helpers now live in
# floorplanner.config and are imported via the star import above.
